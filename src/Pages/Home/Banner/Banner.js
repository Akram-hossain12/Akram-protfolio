...
import img1 from '../../../assets/port3.jpg'
import { FaDownload } from 'react-icons/fa';
import NavTop from '../../Shaerd/NavbarToop/NavTop';
import './Banner.css'
        ...
        <div>
            ...
            <div className="hero lg:mt-20 ">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <img src={img1} alt='' className="animate-pulse -rotate-6 max-w-sm rounded-lg shadow-2xl" />
